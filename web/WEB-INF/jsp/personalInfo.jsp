        ...
        <c:if test="${role == 1}">
            <div class="messager-input" style="height: 56px; margin: 10px;">
                <p align="center" style="font-size: 16px;">
                    ...
                    <input id="employeenum" value="${employeenum}"  class="easyui-textbox" style="width: 300px;height: 32px"/>
                </p>
            </div>
        </c:if>
        <c:if test="${role == 2}">
            <div class="messager-input" style="height: 56px; margin: 10px;">
                <p align="center" style="font-size: 16px;">
                    ...
                    <input id="number" value="${number}"  class="easyui-textbox" style="width: 300px;height: 32px"/>
                </p>
            </div>
        </c:if>
        <div class="messager-input" style="height: 56px; margin: 10px;">
            <p align="center" style="font-size: 16px;">
                ...
                <input id="username" value="${user}" class="easyui-textbox" style="width: 300px;height: 32px"/>
            </p>
        </div>
        <div class="messager-input" style="height: 56px; margin: 10px;">
            <p align="center" style="font-size: 16px;">
                <label for="classs" >班级: </label>
                <input id="classs" value="${classs}" class="easyui-textbox" style="width: 300px;height: 32px"/>
            </p>
        </div>
        <div class="messager-input" style="height: 56px; margin: 10px;">
            <p align="center" style="font-size: 16px;">
                <label for="email" >邮&nbsp;&nbsp;箱: </label>
                <input id="email" value="${email}" class="easyui-textbox"   style="width: 300px;height: 32px"/>
            </p>
        </div>
        <div class="messager-input" style="height: 56px; margin: 10px;">
            <p align="center" style="font-size: 16px;">
                <label for="phone" >手机号: </label>
                <input id="phone" value="${phone}" class="easyui-textbox"  style="width: 300px;height: 32px"/>
            </p>
        </div>
        <c:if test="${role == 1}">
